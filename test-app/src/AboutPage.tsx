...
const XIcon = () => (
  <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.727-8.835-8.164-10.665h7.079l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
  </svg>
);
...
const A: Record<string, Record<SupportedLanguage, string>> = {
  ...
  mission:    { en:'Our Mission',        fa:'ماموریت ما',            ps:'زموږ هدف'            },
  missionTxt: {
    en:'Simplifying date conversions across Gregorian, Solar Hijri, and Lunar Hijri calendars for Afghan and Persian-speaking communities worldwide.',
    fa:'ساده‌سازی تبدیل تاریخ بین تقویم‌های میلادی، هجری شمسی و هجری قمری برای جوامع افغانی و فارسی‌زبان در سراسر جهان.',
    ps:'د افغاني او فارسي ژبو ټولنو لپاره د میلادي، هجري لمریز او هجري سپوږمیز تقویمونو ترمینځ د نیټو بدلول اسانول.',
  },
  developer:  { en:'Developer',         fa:'توسعه‌دهنده',          ps:'جوړوونکی'            },
  ...
  devBio:     {
    en:'Based in Kabul, Afghanistan — building tools that matter for Afghan and broader Muslim communities.',
    fa:'مقیم کابل، افغانستان — در حال ساخت ابزارهایی که برای جوامع افغانی و مسلمان جهان اهمیت دارند.',
    ps:'د کابل، افغانستان اوسیدونکی — د افغاني او مسلمانو ټولنو لپاره د اهمیت وړ وسیلې جوړوي.',
  },
  ...
  version:    { en:'v1.0.0 (Build 12)', fa:'نسخه ۱.۰.۰ (بیلد ۱۲)', ps:'نسخه ۱.۰.۰ (بیلد ۱۲)' },
...
const LEGAL: Record<LegalKey, Record<SupportedLanguage, LegalDoc>> = {
  privacy: {
    ...
    fa: { title:'سیاست حریم خصوصی', body:[
    ...
    <div className="about-page" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className="about-content">
        ...
        <div className="about-profile-header">
          <div className="about-profile-avatar">IL</div>
        ...
        <div className="about-meta-chips">
          ...
          <div className="meta-chip">📱 v1.0.0</div>
          <div className="meta-chip">🛠️ Build 12</div>
        </div>
        ...
        <div className="about-card unified glass">
          ...
          <div className="card-section">
            ...
            <div className="about-social-row">
              ...
              <a href="https://x.com"      className="social-link" aria-label="X"        target="_blank" rel="noopener noreferrer"><XIcon /></a>
              <a href="https://linkedin.com" className="social-link" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer"><LinkedInIcon /></a>
              <a href="https://lemar.app"  className="social-link" aria-label="Website"  target="_blank" rel="noopener noreferrer"><GlobeIcon /></a>
            </div>
          </div>
        </div>
